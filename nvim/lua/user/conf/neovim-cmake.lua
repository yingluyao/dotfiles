...
cmake.setup({
  ...
  samples_path = vim.fn.stdpath('data') .. '/site/pack/packer/start/neovim-cmake/samples', -- Folder with samples. `samples` folder from the plugin directory is used by default.
